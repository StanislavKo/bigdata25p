...
echo -e "\n--\n+> Creating WS source"
curl -s -X PUT -H  "Content-Type:application/json" http://localhost:8083/connectors/sink-iceberg-09/config \
    -d '{
    ...
    "iceberg.catalog.rest.region": "ap-northeast-2",
    "iceberg.catalog.rest.access-key-id": "AAAAAABBBBBBFFFFFFFFF",
    "iceberg.catalog.rest.secret-access-key": "AAAAAAAAAAAAAABBBBBBBBBBBBBBGGGGGGGGGGGGGGGG",
    ...
    "iceberg.tables": "bigdata25.rates_bronze2",
